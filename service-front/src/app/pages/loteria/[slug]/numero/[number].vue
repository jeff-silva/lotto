      ...
      <div class="max-w-7xl mx-auto space-y-6">
          ...
          <div class="flex items-center gap-3 flex-1">
            ...
            <div>
              <h1 class="text-3xl font-semibold text-slate-900">
                Análise do Número {{ $route.params.number }}
              </h1>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
          <div class="bg-white border border-slate-200 rounded-md shadow-sm p-4">
            ...
            <p class="text-3xl font-bold" style="color: #209869">127</p>
            <p class="text-xs text-slate-500 mt-1">
              em 2.650 concursos (4.79%)
            </p>
          </div>
        ...
        <div class="bg-white border border-slate-200 rounded-md shadow-sm">
          <div class="px-5 py-4 border-b border-slate-200">
            ...
            <p class="text-xs text-slate-500 mt-0.5">
              Top 10 combinações com o número {{ $route.params.number }}
            </p>
          </div>
          <div class="p-5">
        ...
        <div class="bg-white border border-slate-200 rounded-md shadow-sm">
          <div class="px-5 py-4 border-b border-slate-200">
            ...
            <p class="text-xs text-slate-500 mt-0.5">
              Últimos 20 sorteios do número {{ $route.params.number }}
            </p>
          </div>
